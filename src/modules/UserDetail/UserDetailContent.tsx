...
export default function UserDetailContent() {
  ...
  if (loading === true) {
    return <div style={{ display: 'block', backgroundColor: '#888', opacity: '0.5',zIndex:'2000' }} className="modal fade show" id="modelId2" tabIndex={-1} role="dialog" aria-labelledby="modelTitleId" aria-modal="true">
